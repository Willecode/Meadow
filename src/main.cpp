...
int main()
{
    ...
    // glm::vec3 cameraPos = glm::vec3(0.0f, 0.0f, 3.0f);
    // glm::vec3 cameraZDir = glm::normalize(cameraPos - cameraTarget);
    // glm::vec3 cameraXDir = glm::cross(glm::vec3(0.0f, 1.0f, 0.0f), cameraZDir);
    // glm::vec3 cameraYDir = glm::cross(cameraZDir, cameraXDir);
