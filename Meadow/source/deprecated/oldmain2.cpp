...
int main()
{
    ...
    importObj->setShader(&phongTexShader);
    importObj->setModelMatrix(glm::translate(importObj->getModelMatrix(), glm::vec3(0.0f, -10.0f, -5.0f)));
    importObj->setModelMatrix(glm::rotate(importObj->getModelMatrix(), 180.0f, glm::vec3(0.0f, 1.0f, 0.0f)));
