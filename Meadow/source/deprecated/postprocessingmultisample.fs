...
void main()
{
    ...
    ivec2 texelCoords = ivec2(viewportWidth * TexCoords.x, viewportHeight * TexCoords.y);
    vec4 outCol = texelFetch(screenTextureMS, texelCoords, 3);
